...
public class Igrac extends Osoba {
	...
	public Igrac(String ime, String prz){
		super(ime, prz);
	}
	public Igrac(String ime, String prz, int brDresa, int visina, Pozicija pozicija,
			List<StatistikaIgraca> statistikaIgraca, Klub klub) {
		super(ime, prz);
	...
	public Igrac(int brDresa, int visina, Pozicija pozicija, List statistikaIgraca, Klub klub) {
		super();
		this.brDresa = brDresa;
		this.visina = visina;
		this.pozicija = pozicija;
